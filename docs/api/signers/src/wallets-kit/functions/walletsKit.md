...
> **walletsKit**(`opts`, `injected?`): `BuckspaySigner`

Defined in: [packages/signers/src/wallets-kit/signer.ts:26](https://github.com/bucks-pay/buckspay-sdk/blob/e72c277e7ff52faad26c1268225fd15d97119646/packages/signers/src/wallets-kit/signer.ts#L26)
